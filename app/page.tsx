    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100 px-4">
      <div className="bg-white p-8 rounded-lg shadow-lg text-gray-800 max-w-7xl w-full">
        ...
        <p className="mb-4 text-justify">
          The purpose of this application is to use popular and often-used DevOps tools and principles, bringing them together in cohesion to demonstrate how you can easily automate testing, generate changelogs, deploy to a Kubernetes infrastructure, and much more.
        </p>
        ...
        <ul className="list-disc list-inside mb-4 ml-4">
          ...
          <li><strong>GitOps</strong>: Modern operational framework that leverages Git as a single source of truth for managing infrastructure and application deployments. It applies the principles of DevOps by using Git repositories to store the desired state of a system, enabling automated deployment, monitoring, and management of infrastructure through version control.</li>
        </ul>
        ...
        <ul className="list-disc list-inside mb-4 ml-4">
          ...
          <li>
            <a href="https://argocd.samec.dev" className="text-blue-500 hover:underline" target="_blank" rel="noopener noreferrer">
              ArgoCD UI (public:RPTl4kMmhRwzjRq)
            </a>
          </li>
          <li>
            <a href="https://grafana.samec.dev" className="text-blue-500 hover:underline" target="_blank" rel="noopener noreferrer">
              Grafana Dashboard (public:RPTl4kMmhRwzjRq)
            </a>
          </li>
        </ul>
